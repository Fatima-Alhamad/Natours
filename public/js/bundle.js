    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            location.reload(true); //we put true to force reload from the server and not from the cache
          }
          _context2.next = 10;
          break;
        case 7:
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: type === 'data' ? 'http://localhost:7000/api/v1/users/updateMe' : 'http://localhost:7000/api/v1/users/updatePassword',
            data: data
          });
        case 3:
          res = _context.sent;
...
var stripe = Stripe('pk_test_51Q6Z1uRwoWVRg7TUuUEe7ZNA8ifqKYTXnp3QzMEnZqyVlhqeitIFJXfk5G277wmqNHiUYT2qJIyFzhS2ZR4afVug001ifUwjGM');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://localhost:7000/api/v1/bookings/checkout-session/".concat(tourId)
          });
        case 3:
...
if (updatePasswordForm) {
  updatePasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var currentPassword, password, confirmPassword, data;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
